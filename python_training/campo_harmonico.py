from python_training.acordes import triade
from python_training.escalas import escala
...
def campo_harmonico(tonica: str, tonalidade: str) -> dict[str, list[str]]:
    ...
    graus_convertidos = [
        _converte_graus(acorde, grau) for acorde, grau in zip(acordes, graus)
    ]

    return {'acordes': acordes, 'graus': graus_convertidos}
